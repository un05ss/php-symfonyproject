 ...
 */
final class Version20260111020745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note ADD etudiant_id INT NOT NULL, DROP etudiant');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note ADD etudiant VARCHAR(100) NOT NULL, DROP etudiant_id');
    }
}
